              ...
              <tbody>
                <tr>
                  <td><h2 style="color:#730608; text-align:center"><span style="text-align: center">Welcome <?php echo  $_SESSION['auname']; ?><br>
                    <br>
                    List of Registered Customers </span>
                    </h2>
                    ...
                    <table width="800" border="0" align="center" cellpadding="10" cellspacing="0">
                      <tbody>
                        <tr bgcolor="#82E8AD" style="text-align: center">
                          <th width="109">Full Name</th>
                          <th width="106">Date of birth</th>
                          <th width="156">Email</th>
                          <th width="121">Mobile No.</th>
                          <th width="91">Address</th>
                          <th width="128">Username</th>
                        ...
                        <tr>
                          ...
                          <td style="border-bottom:2px solid #82E8AD" height="42"><?php echo $row["dob"];?></td>
                          ...
                          <td style="border-bottom:2px solid #82E8AD"><?php echo $row["address"];?></td>
                          <td style="border-bottom:2px solid #82E8AD"><?php echo $row["username"];?></td>
